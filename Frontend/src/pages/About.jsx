...
const About = () => {
  ...
  return (
    <div style={containerStyle}>
      ...
      <h3 style={{ fontSize: '1.5rem', color: '#3b82f6', marginBottom: '15px' }}>Nishu Kumar (@nisshukumar)</h3>

      <p style={{ color: '#a1a1aa', fontSize: '1.2rem', lineHeight: '1.8', maxWidth: '600px', margin: '0 auto 30px auto' }}>
        <strong>Join the community and grow together!</strong> Welcome to my platform where we fullfill all your daily needs.
      </p>

      <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center', gap: '10px', marginTop: '20px' }}>
        <a href="" target="_blank" rel="noreferrer" style={socialBtnStyle}>🌐 Website</a>
        <a href="" target="_blank" rel="noreferrer" style={{ ...socialBtnStyle, background: 'rgba(59, 130, 246, 0.12)', borderColor: '#3b82f6', color: '#3b82f6' }}>📺 YouTube</a>
